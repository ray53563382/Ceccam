  ...
  <div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 col-lg-8">
          ...
          <div v-html="docTextBody" class="col-12 testy" style="margin-bottom:5%"></div>
          <div v-show="showdescarga" class="col-md-12 col-lg-8">
            <div class="col-12">
              <p>
                <a ref="downloadpdf" class="buttonDownload">Descarga pdf</a>
              </p>
            </div>
          </div>
          ...
          <div class="col-12" v-show="docPdf != null && this.docPdf2 == null " >
           ...
           <div class="col-12" v-show="this.docPdf2 != null" >
            <div class="row my-5">
              <div class="col-12">
                  <a ref="downloadpdf" class="buttonDownload" @click="goToPdf()"  v-bind:href="url" style="float: right;">Descarga pdf</a>
              </div>
            </div>
          </div>
    ...
    <div class="container" v-if="registros.length != 0">
      <h4 class="p-title mt-50">
        <b>Te podría interesar</b>
      </h4>
      <div class="row">
        <div class="col-12 col-lg-3 col-md-6 box" @click="goToDocumentView(registros[0].id)">
        ...
        <div class="col-12 col-lg-3 col-md-6 box" @click="goToDocumentView(registros[1].id)">
        ...
        <div class="col-12 col-lg-3 col-md-6 box" @click="goToDocumentView(registros[2].id)">
        ...
        <div class="col-12 col-lg-3 col-md-6 box" @click="goToDocumentView(registros[3].id)">
  ...
  created() {
    ...
    axios({
      ...
      .then(resp => {
        ...
        this.docPdf = resp.data.pdf;

        if(resp.data.imgFirebase != null){
          this.docImage = resp.data.imgFirebase;
        }
        if(resp.data.pdfFirebase != null){
          this.docPdf2 = resp.data.pdfFirebase;
        }else{
        this.$refs.downloadpdf.download = "documento.pdf";
        this.$refs.downloadpdf.href = resp.data.pdf;
        }
        console.log("*******************************");
        console.log(resp.data.imgFirebase);
        console.log(resp.data.pdfFirebase);
        console.log("*******************************");
