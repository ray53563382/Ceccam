        ...
        <div class="float-left float-sm-none w-1-3 w-sm-100 h-100 h-sm-600x">
          ...
          <div class="pl-5 ptb-5 pl-sm-0 pos-relative h-50">
            ...
            >
              ...
              <div class="abs-blr color-white p-20 bg-sm-color-7 hoverevent">
                <h4 class="mb-10 mb-sm-5">
...
export default {
  ...
  mounted() {
    ...
    axios({
      ...
      this.relevantes.forEach(element => {
        if (
          element.imgdesmostrativa == null ||
          element.imgdesmostrativa == undefined ||
          element.imgdesmostrativa == ""
        ) {
