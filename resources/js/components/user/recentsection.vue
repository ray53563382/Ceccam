    ...
    <div class="container" v-if="dataCharger == true">
      <div class="row">
        <div class="col-md-12 col-lg-8">
            ...
            <div class="col-sm-6">
              ...
              >
                <div class="wh-100x abs-tlr">
                  <img
                  v-show="recientes[1].imgdesmostrativa != undefined"
              ...
              >
                <div class="wh-100x abs-tlr">
                  <img
                   v-show="recientes[2].imgdesmostrativa != undefined"
              ...
              >
                <div class="wh-100x abs-tlr">
                  <img
                   v-show="recientes[3].imgdesmostrativa != undefined"
              ...
              >
                <div class="wh-100x abs-tlr">
                  <img
                   v-show="recientes[4].imgdesmostrativa != undefined"
          ...
          <div class="row">
            <div class="col-sm-4 box hoverevent" @click="goToDocumentView(recientes[5].id)">
              <img
               v-show="recientes[5].imgdesmostrativa != undefined"
            ...
            <div class="col-sm-4 box hoverevent" @click="goToDocumentView(recientes[6].id)">
              <img
               v-show="recientes[6].imgdesmostrativa != undefined"
            ...
            <div class="col-sm-4 box hoverevent" @click="goToDocumentView(recientes[7].id)">
              <img
               v-show="recientes[7].imgdesmostrativa != undefined"
            ...
            <div class="col-sm-4 box hoverevent" @click="goToDocumentView(recientes[8].id)">
              <img
                v-show="recientes[8].imgdesmostrativa != undefined"
            ...
            <div class="col-sm-4 box hoverevent" @click="goToDocumentView(recientes[9].id)">
              <img
                v-show="recientes[9].imgdesmostrativa != undefined"
            ...
            <div class="col-sm-4 box hoverevent" @click="goToDocumentView(recientes[10].id)">
              <img
               v-show="recientes[10].imgdesmostrativa != undefined"
        ...
        <div class="col-md-6 col-lg-4">
          <div class="pl-20 pl-md-0">
            <div class="mtb-50">
              ...
              >
                <div class="wh-100x abs-tlr">
                  ...
                  <img v-show="noticias[0].imgdesmostrativa != undefined" :src="noticias[0].imgdesmostrativa" alt />
                </div>
                <div class="ml-120 min-h-100x">
                  <h5>
              ...
              >
                <div class="wh-100x abs-tlr">
                  <img v-show="noticias[1].imgdesmostrativa != undefined" :src="noticias[1].imgdesmostrativa" alt />
                </div>
                <div class="ml-120 min-h-100x">
                  <h5>
              ...
              >
                <div class="wh-100x abs-tlr">
                  <img v-show="noticias[2].imgdesmostrativa != undefined" :src="noticias[2].imgdesmostrativa" alt />
                </div>
                <div class="ml-120 min-h-100x">
                  <h5>
              ...
              >
                <div class="wh-100x abs-tlr">
                  <img v-show="noticias[3].imgdesmostrativa != undefined" :src="noticias[3].imgdesmostrativa" alt />
                </div>
                <div class="ml-120 min-h-100x">
                  <h5>
              ...
              <!-- oflow-hidden -->
              <a class="dplay-block btn-brdr-primary mt-20 mb-md-50" @click="goToAllNews">
                <b>Ver más noticias.</b>
              </a>
            </div>
            ...
            <div class="mtb-50">
              ...
              >
                <div class="wh-100x abs-tlr">
                  <img v-if="recientes[10].imgdesmostrativa" :src="recientes[10].imgdesmostrativa" />
                </div>
                <div class="ml-120 min-h-100x">
                  <h5>
...
<iframe src="https://player.vimeo.com/video/334661647" width="320" height="240" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                ...
                <iframe
                  ...
                  :src="
                                        'https://www.youtube.com/embed/' +
                                            resgistrosMulti[0].url +'?autohide=0'
                                    "
                  frameborder="0"
...
export default {
  ...
  mounted() {
    ...
    console.log(this.resgistrosMulti.reverse());
